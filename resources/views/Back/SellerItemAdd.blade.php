    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <p class="alert alert-danger text-center"> Please Verified Your Shop !!! </p>
            </div>
            @else
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <form action="{{ route('seller.Item.store') }}" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="itemTitle" name="itemTitle" type="text"
                                        ...
                                        placeholder="Baju Melayu" required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" required
                                        ...
                                        id="priceItem" name="priceItem" placeholder="Price Of Item">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" required
                                        ...
                                        id="qtyItem" name="qtyItem" placeholder="Qty Item">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select type="text" required
                                        ...
                                        <option value="{{ $itemType['id'] }}">{{ $itemType['nameItemType'] }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea id="itemDesc" name="itemDesc" type="text"
                                        ...
                                        onfocus="this.value=''" placeholder="Description Of Item" required></textarea>
